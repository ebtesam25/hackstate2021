...
void loop() {
  ...
  if (piccType != MFRC522::PICC_TYPE_MIFARE_MINI &&  
    ...
    if (nuidPICC[0] == prevID2[0]) {
      Serial.println("previous 2");
      flag2 = false;
      prevID2[0] = 0;
      Serial.print(F("$$"));
    }
    ...
    if (nuidPICC[0] == prevID3[0]) {
      Serial.println("previous 3");
      flag3 = false;
      prevID3[0] = 0;
      Serial.print(F("$$"));
    }
    ...
    if (nuidPICC[0] == prevID4[0]) {
      Serial.println("previous 4");
      flag4 = false;
      prevID4[0] = 0;
      Serial.print(F("$$"));
    }
    ...
    if ((flag1 == true) && (flag2 == false) && (flag3 == false) && (flag4 == false)) {
          Serial.print(F("##"));
          for (byte i = 0; i < 4; i++) {
            prevID2[i] = nuidPICC[i];
            flag2 = true;      
      }
    }

    else { if ((flag1 == true) && (flag2 == true) && (flag3 == false) && (flag4 == false)) {
          Serial.print(F("##"));
          for (byte i = 0; i < 4; i++) {
            prevID3[i] = nuidPICC[i];
            flag3 = true;      
      }
    }
    else {
